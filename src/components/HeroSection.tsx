        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <motion.p
              ...
              className="text-white/80 text-sm md:text-base max-w-xl mb-8 leading-relaxed"
            >
            ...
            >
              ...
              >
                ...
                href="#experiencia"
                className="px-7 py-3 rounded-full border border-white/40 text-white font-medium text-sm hover:border-primary/50 hover:text-primary transition-all text-center"
              >
